...
**Fixture flow:** `created_task` en `conftest.py` crea una tarea real en la API y devuelve el response y el payload original. `test_get_task` y `test_update_task` dependen de este fixture — pytest lo resuelve automáticamente por nombre de parámetro.
